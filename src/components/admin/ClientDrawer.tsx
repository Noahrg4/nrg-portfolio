    ...
    >
      <div className="flex flex-col gap-6">
        ...
        <div className="flex flex-wrap items-center gap-3">
          ...
          {client.siteUrl && (
            <a
              ...
              className="font-mono text-[11px] text-accent hover:text-accent/80 underline break-all"
            >
              {client.siteUrl}
            </a>
          )}
        ...
        <div className="flex flex-wrap gap-2">
          ...
          >
            {verifying ? "…" : "✓ Verify operating"}
          </button>
          {client.lastVerifiedAt && (
            <span className="self-center font-mono text-[11px] text-ink-subtle">
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <select
              ...
              disabled={saving}
              className="rounded-md border border-hairline bg-surface-2 px-3 py-2 text-base text-ink focus:border-accent focus:outline-none"
            >
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="flex flex-col gap-1.5">
              <label className={labelClass}>One-time value ($)</label>
              <input
                type="number"
                min={0}
                value={oneTimeValue}
            ...
            <div className="flex flex-col gap-1.5">
              <label className={labelClass}>Monthly charge ($)</label>
              <input
                type="number"
                min={0}
                value={monthlyCharge}
        ...
        <div className="rounded-lg border-l-2 border-accent/35 bg-surface-2 pl-4 py-3 pr-4">
          <div className="grid grid-cols-1 gap-1.5 font-mono text-[11px]">
            ...
            {client.phone && (
              <a href={`tel:${client.phone}`} className="text-accent hover:text-accent/80">
                {client.phone}
              </a>
            )}
            {client.email && (
              <a href={`mailto:${client.email}`} className="text-accent hover:text-accent/80 break-all">
                {client.email}
              </a>
            )}
          </div>
