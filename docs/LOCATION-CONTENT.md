# Location Content Validation Reference
*All values below are the source of truth. QA verifies code matches this doc exactly.*

---

## ROOT (/) — Generic, national

| Field | Value |
|---|---|
| heroLocationLine | null (nothing renders) |
...
| Card | Title |
|---|---|
| Gushow Excavating | "Full Web Presence — Excavating Company" |
| ReWilding Life | "Brand Site — Nature & Wellness Content Platform" |
| The Rustic Table | "Full Web Presence — Restaurant" |
| Martinez HVAC | "Lead Generation Site — HVAC Company" |
| Reyes & Associates | "Client Acquisition Site — Law Office" |
...
| Gushow Excavating | "Full Web Presence — Excavating Company" |
| ReWilding Life | "Brand Site — Nature & Wellness Content Platform" |
| The Rustic Table | "Full Web Presence — Houston Restaurant" |
| Martinez HVAC | "Lead Generation Site — Houston HVAC Company" |
| Reyes & Associates | "Client Acquisition Site — Houston Law Office" |
...
| Gushow Excavating | "Full Web Presence — Excavating Company" |
| ReWilding Life | "Brand Site — Nature & Wellness Content Platform" |
| The Rustic Table | "Full Web Presence — Texas Restaurant" |
| Martinez HVAC | "Lead Generation Site — Texas HVAC Company" |
| Reyes & Associates | "Client Acquisition Site — Texas Law Office" |
...
### What makes each location page feel earned (not templated):

**Houston** — References "from your neighborhood," "based in Houston," specific dig at Squarespace templates (a pain point Houston small biz owners recognize), "No agencies, no runaround" in the contact copy (addresses a real Houston market complaint).

**Texas** — Acknowledges the broader geography honestly: "Based in Houston and working across Texas." Doesn't overclaim Houston-specific knowledge for non-Houston TX leads.

**Michigan** — Noah's roots are real credibility: "I grew up in Michigan," the Gushow Excavating project is a real Michigan client. "Stop relying on a Facebook page" is a specific, accurate observation about Michigan small business digital maturity.

**Root** — No location lock. Clean, national positioning. Works as a fallback for any traffic source.
